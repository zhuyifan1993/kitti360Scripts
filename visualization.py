...
DATA_PATH = 'data_3d_car_pointcloud/car'

data = np.load(os.path.join(DATA_PATH, '38_canonical.npy'))
...
print(pcd)
o3d.io.write_point_cloud(os.path.join(DATA_PATH, '38_canonical.ply'), pcd)
